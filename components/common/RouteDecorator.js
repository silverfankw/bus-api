...
export const RouteDecorator = props => {
    ...
    const IS_REGULAR_ROUTE =
        ...
        !IS_LWB_AIRPORT_ROUTE && !IS_LWB_AIRPORT_OVERNIGHT_ROUTE && !IS_LWB_S_ROUTE && !IS_LWB_EVENT_ROUTE
    ...
    switch (co[0]) {
        ...
        case "nlb":
            if (IS_REGULAR_ROUTE)
                ...
                return <span className="bg-black text-yellow-300 px-2 py-0.5 font-bold">{route}</span>
                ...
                return <span className="bg-[#000070] text-yellow-300 px-2 py-0.5 font-bold">{route}</span>
                ...
                return <span className="bg-amber-600 px-2 py-0.5 font-bold">{route}</span>
        default:
            return <span className="px-2 py-0.5 font-bold">{route}</span>
    }
}